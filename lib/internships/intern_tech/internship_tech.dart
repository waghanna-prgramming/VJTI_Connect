...
class TechInternship extends StatefulWidget {
  const TechInternship({super.key});

  @override
  State<TechInternship> createState() => _TechInternshipState();
}

class _TechInternshipState extends State<TechInternship> {
  @override
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            ...
            Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => InternshipDomains(),),);
          },
        ),
        centerTitle: true,
        title: Text('IT/TECH'),
